    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center p-6 pointer-events-none font-sans">
      ...
      <div className="max-w-2xl w-full text-center space-y-6 pointer-events-auto animate-fade-in">
        ...
        <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-slate-950/90 border border-amber-500/40 shadow-2xl backdrop-blur-2xl">
          ...
          <span className="text-xs font-game font-bold tracking-widest uppercase text-amber-400">
            SDGS CREATIVE WEB COMPETITION • CULTURE VERSE
          </span>
        </div>
        ...
        <div className="space-y-6 p-8 md:p-12 rounded-3xl bg-slate-950/90 backdrop-blur-2xl border border-white/20 shadow-[0_0_60px_rgba(0,0,0,0.9)] relative overflow-hidden">
          ...
          <div className="space-y-3 relative z-10">
            <div className="flex items-center justify-center gap-2 text-xs font-game font-bold text-cyan-400 tracking-widest uppercase">
              <Terminal className="w-4 h-4" />
              <span>3D INTERACTIVE RPG HERITAGE SIMULATOR</span>
            </div>

            <h1 className="text-4xl md:text-6xl font-title font-black tracking-tight text-white uppercase leading-none">
              SASIRANGAN<br />
              <span className="text-gold">
                METAVERSE
              </span>
            </h1>
            <p className="text-xs md:text-sm font-game font-bold tracking-widest text-slate-300 uppercase pt-1">
              SDG 11 Target 11.4 • Protecting Cultural Heritage
            </p>
          </div>
          ...
          <div className="pt-4 flex flex-col items-center justify-center gap-4 relative z-10">
            <button
              ...
              disabled={!is3dLoaded}
              className={`w-full sm:w-auto px-12 py-5 rounded-2xl font-game font-bold text-base md:text-lg tracking-wider uppercase flex items-center justify-center gap-3.5 shadow-2xl transition-all duration-300 cursor-pointer border ${
                is3dLoaded
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-game text-slate-300 font-bold uppercase pt-3 border-t border-white/10 w-full">
              <span className="flex items-center gap-1.5"><Cpu className="w-4 h-4 text-cyan-400" /> WASD / Arrow Keys to Walk</span>
              <span>•</span>
              <span className="flex items-center gap-1.5"><Compass className="w-4 h-4 text-amber-400" /> Space to Jump</span>
              <span>•</span>
