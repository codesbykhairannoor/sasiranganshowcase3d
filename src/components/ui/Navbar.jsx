  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-4 py-3 md:px-8 md:py-4 pointer-events-none font-sans">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 pointer-events-auto">
        ...
        {/* Brand & Title (Title Case Formatting - No ALL CAPS!) */}
        <div 
        ...
        >
          ...
          <div>
            <h1 className="font-title font-black text-xs md:text-sm tracking-wider text-white flex items-center gap-1.5 capitalize">
        ...
        {currentView !== 'hero' && (
          <div className="hidden md:flex items-center gap-4 bg-slate-950/90 backdrop-blur-xl px-6 py-2.5 rounded-full border border-white/20 shadow-2xl animate-fade-in font-game font-bold text-xs">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-slate-200 capitalize tracking-wide">Motif Ditemukan :</span>
            ...
            {isAllDiscovered && (
              <button
                ...
                className="flex items-center gap-1.5 bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-400 hover:to-yellow-500 text-slate-950 text-xs font-black px-4 py-1.5 rounded-full shadow-[0_0_20px_rgba(245,158,11,0.6)] animate-bounce transition-all cursor-pointer font-game capitalize tracking-wide"
              >
        ...
        <div className="flex items-center gap-2 md:gap-3 font-game font-bold">
          ...
          >
            ...
            <span className="hidden sm:inline capitalize">SDG 11 Info</span>
          </button>
